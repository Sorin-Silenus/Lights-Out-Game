...
class Engine {
    private:
        ...
        /// @brief game buttons to be rendered.
        /// @details Initialized in initShapes()
        vector<unique_ptr<Shape>> buttons;
        /// @brief outline of game buttons to be rendered.
        /// @details Initialized in initShapes()
        vector<unique_ptr<Shape>> outline;
        ///@brief reads if the user is currently clicking the mouse key
        ///@details Initialized in processInput method of Engine class
        bool mousePressed;
        ///@brief reads if the user has clicked the mouse key in the previous frame
        ///@details Initialized in processInput method of Engine class
        bool mousePressedLastFrame = false;
        ///@brief reads the current position of the cursor on the screen
        ///@details Initialized in processInput method of Engine class
    ...
    public:
        ...
        void switchState(unique_ptr<Shape>& button);
